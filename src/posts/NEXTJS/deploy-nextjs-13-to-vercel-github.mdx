...
![regist](/posts/NEXTJS/deploy-nextjs-13-to-vercel-github/vercel-git-regist.jpg)
<br/>
## 2. Configure you deployment build setting

After pressing import, you can configure your deployment build setting

![buildSetting1](/posts/NEXTJS/deploy-nextjs-13-to-vercel-github/vercel-build-1.jpg)
...
- Build and Output Settings : commands for building and deployment
    ...
    - ![buildSetting2](/posts/NEXTJS/deploy-nextjs-13-to-vercel-github/vercel-build-2.jpg)
...
![detail](/posts/NEXTJS/deploy-nextjs-13-to-vercel-github/vercel-deploy-detail.jpg)
...
![build3](/posts/NEXTJS/deploy-nextjs-13-to-vercel-github/vercel-dev-main.jpg)